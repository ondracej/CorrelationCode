function [] = analyzePopRSCResponses_Stats()
...
switch gethostname
    ...
    case 'deadpool'
        ...
        %100 vs 50
        d_stim1 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-100ms.mat']);
        d_stim2 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-50ms.mat']);
%         
        %100 vs 200
%         d_stim1 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-100ms.mat']);
%         d_stim2 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-200ms.mat']);
        
        %100 vs 10ms 
        %d_stim1 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-100ms.mat']);
        %d_stim2 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-10ms.mat']);
        
        %50 vs 10ms 
%         d_stim1 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-50ms.mat']);
%         d_stim2 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-10ms.mat']);
%         
        %50 vs 200ms 
        %d_stim1 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-50ms.mat']);
        ...
        %10 vs 200ms 
        %d_stim1 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-10ms.mat']);
        %d_stim2 = load([baseDir 'SortedData/WNSpontOrStim-1s/AudSpkData/RSC-Stim-200ms.mat']);
