function [binSpkCnts_RSC] = extractSpikeAnalysisWindows_RSC(OnOff_params, spks, raw_data_info, spikeWindow_RSC_s)
    ...
    for m = 1 : num_channels
        ...
        for p = 1 : unique_stims
            ...
            for s = 1 : reps
                ...
                start_stim = stim_start(i);
                stop_stim = stim_stop(i);
                ...
                chan_SpkTimes_RSC{p, s} = RSC_Spks;
                chan_SpksCnts_RSC(p, s) = RSC_SpkCnt;
        ...
        binSpkCnts_RSC.SpkTimes{1, chan} = chan_SpkTimes_RSC;
        binSpkCnts_RSC.SpkCnt{1, chan} = chan_SpksCnts_RSC;
